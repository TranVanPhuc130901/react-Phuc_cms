        ...
        <div className={StyleProduct.containerProduct}>
            <div className="flex justify-between items_center border-b-[1px] pb-2">
                <div className={StyleProduct.headLeft}>
                    <h1 className='font-bold text-3xl mb-2'>Product List</h1>
            ...
            <div className='w-full'>
                <div className='row flex items-center justify-between mx-4 text-center'>
                     <div className='cell w-1/5 p-2 header'>Name</div>
                     <div className='cell w-1/5 p-2 header'>Category</div>
                     <div className='cell w-1/5 p-2 header'>Date</div>
                     <div className='cell w-1/5 p-2 header'>Status</div>
                     <div className='cell w-1/10 p-2 header'>Actions</div>
                     <div className='cell w-1/10 p-2 header'>
                        <input type="checkbox" />
                    </div>  
                </div>
                <div className='row custom-shadow py-8 flex items-center justify-between cursor-pointer px-4 text-center mb-4'>
                    <div className='cell w-1/5 p-2'>Product Name</div>
                    <div className='cell w-1/5 p-2'>Category</div>
                    <div className='cell w-1/5 p-2'>2020-01-01</div>
                    <div className='cell w-1/5 p-2'>Active</div>
                    <div className='cell w-1/10 p-2'>action</div>
                    <div className='cell w-1/10 p-2'>
                        <input type="checkbox" />
                    </div>
                </div>
                <div className='row custom-shadow py-8 flex items-center justify-between cursor-pointer px-4 text-center mb-4'>
